...
This repository includes a full parser for MesaNote written from scratch in Python 3.12. In developing MesaNote, my goals are both to explore language creation and build something that I can use myself. For these reasons, the project includes minimal dependencies and focuses on simple, practical features focused on notetaking.
...
From a design perspective, MesaNote is intentionally minimal, being small enough to fully describe with a compact EBNF grammar and parse using a hand-written recursive descent parser.
